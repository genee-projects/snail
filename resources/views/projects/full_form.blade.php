...
<div class="form-group">
    ...
    <label for="project-contact" class="col-md-2 control-label">联系人电话</label>
    <div class="col-md-4">
...
<div class="form-group">
    ...
    <label for="project-contact" class="col-md-2 control-label">联系人邮箱</label>
    <div class="col-md-10">
...
<div class="form-group">
    ...
    <label for="project-divorced-time" class="col-md-2 control-label">实际验收时间</label>
    <div class="col-md-4">
        <div class="date">
...
<div class="form-group">
    ...
    <label for="project-seller" class="col-md-2 control-label">销售负责人</label>
    <div class="col-md-4">
        <input value="{{ $project->seller or '' }}" name="seller" type="text" class="form-control" id="project-seller" placeholder="刘玉川">
    </div>

    <label for="project-seller" class="col-md-2 control-label">工程师负责人</label>
    <div class="col-md-4">
...
<div class="form-group">
    <label for="project-deploy-address" class="col-md-2 control-label">客户地址</label>

    <div class="col-md-10">
        <textarea id="project-deploy-address" class="col-md-2 form-control" rows="2" name="deploy_address">{{ $project->deploy_address or ''}}</textarea>
    </div>
</div>


<div class="form-group">
    <label form="project-login-url" class="col-md-2 control-label">登录地址</label>
    <div class="col-md-10">
...
<div class="form-group">
    ...
    <label for="project-way" class="col-md-2 control-label">乘车路线</label>

    <div class="col-md-10">
        <textarea id="project-way" class="col-md-2 form-control" rows="2" name="way">{{ $project->way or ''}}</textarea>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea id="project-description" class="col-md-2 form-control" rows="2" name="description">{{ $project->description or ''}}</textarea>
    </div>
</div>
