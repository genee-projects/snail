...
class RPC
{
    ...
    {
        return new \App\Gini\RPC($this->_url, $this->_path ? $this->_path.'/'.$name : $name, $this->_cookie, $this->_header);
    }
    ...
    public function post($post_data, $timeout = 5)
    {
        ...
        if ($errno) {
            ...
            throw new \App\Gini\RPC\Exception("transport error: $message", -32300);
        }
